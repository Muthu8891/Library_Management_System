...
import com.example.Library_Management_System.service.IMPL.BorrowerServiceImpl;
...
class BorrowerServiceTest {
    ...
    void testBorrowBook() {
        ...
        Book book = new Book(1L, "1234567890", "Test Book123", "Test Author123", null);
    ...
    void testBorrowBookAlreadyBorrowed() {
        ...
        assertEquals("Book borrowed already", exception.getMessage());
    }
    ...
    void testReturnBookNotBorrowed() {
        ...
        assertEquals("Book not borrowed by this borrower", exception.getMessage());
    }
    ...
    void testBorrowBook_BorrowerNotFound() {
        ...
        // Then
        assertEquals("Borrower not found: " + borrowerId, exception.getMessage());
